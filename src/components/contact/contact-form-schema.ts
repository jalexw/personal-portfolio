import { z } from "zod";
import { MessageCategoryValue, messageCategoryValues } from "./message-category";
...
export const contactFormSchema = z.object({
  ...
  subject: z.string().refine(
    (value): value is MessageCategoryValue => (messageCategoryValues as string[]).includes(value)
  ),
